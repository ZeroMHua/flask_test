# -*- coding: utf-8 -*-
"""
Created on Wed May  8 15:04:18 2019
SVM 适合处理小型高纬度的数据集，对于数据集较大的训练集，训练速度较慢，效果不佳
@author: Season
"""
#import numpy as np
...
#C = 0.5
#gamma = 0.5
#SVM(mdata,target,vars_c,vars_d,testdata,kernel,C,gamma)
 # In[]
def SVM(mdata, target, vars_c, vars_d, testdata=None, kernel = "linear", C = 1, gamma = 0.5):
