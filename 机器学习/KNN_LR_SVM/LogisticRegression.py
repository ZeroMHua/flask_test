# -*- coding: utf-8 -*-
"""
Created on Thu May  9 14:16:18 2019
...
testdata=None
#n_neighbors = 6
LogisticRegression(mdata, target, vars_c, vars_d, testdata=None)

# In[]
def LogisticRegression(mdata, target, vars_c, vars_d, testdata = None):
