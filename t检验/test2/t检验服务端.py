...
def index():
    ...
    #                    })
    return jsonify(yy={"colNames": ['N值', '均值', '标准差', '最小值', '75%位数', '最大值'],
                       name1: [12, xx, bzc, zxz, bfw, zdz],
                       name2: [13, yy, bzc2, zxz2, bfw2, zdz2],
                       "colNames2": ['均值差', 't值', 'p值', '样本1均值', '样本2均值'],
                       '配对t检验': [jzc, round(t, 2), round(p, 8), xx, yy]
